...
public class Main {
	...
	public static void main(String[] args) {
		...
		case 2:
			System.out
					.println("A atmosfera de outono realmente é sem igual,e tbm mt bonita por conta de suas folhas :)");
			break;

		case 3:
			System.out.println(
					"Inverno tbm é a minha favorita XD nada melhor doq um chocolate quente dentro de casa não é msm?");
			break;
