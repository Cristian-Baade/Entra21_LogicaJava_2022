...
public class Main {
	...
	public static void main(String[] args) {
		...
		case "amarelo":
			System.out.println(
					"A cor da felicidade! uma cor que exala alegria onde ela estiver,é uma cor bem divertida X)");
			break;

		case "vermelho":
			System.out.println(
					"Hmm a minha cor favorita XD tbm relacionada a paixão e ao perigo,uma cor realmente tentadora para qm a vê");
			break;
		}
	}
}
