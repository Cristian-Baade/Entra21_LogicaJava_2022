...
public class Main {
	...
	private static void aprenderMatrizesInicializadas() {
		...
		String ementa[][] = { { "Metodologias ágeis", "introdução", "metodologias", "git" },//length 4
				{ "lógica com java", "variaveis", "constantes", "comentários", "desvios condicionais","laços de repetição" },//length 6
				{ "POO", "Classes", "Objetos", "Herança", "Polimorfismo", "Encapsulamento", "conceitos" },//length 7
		};//length 3
