...
public class Main {
	public static void main(String[] args) {
		...
		final byte diasJaneiro = 31, diasFevereiro = 28, diasMarco = 31, diasAbril = 30, diasMaio = 31, diasJunho = 30,
				diasJulho = 31, diasAgosto = 31, diasSetembro = 30, diasOutubro = 31, diasNovembro = 30,
				diasDezembro = 31;
		...
		// Dependendo o mes informado o programa ira corresponder com o signo que tem em
		// cada mes
		switch (mes) {
		case "1":
		case "janeiro": {
	...
	// Essas funções são para invalidar se a pessoa colocou um numero <1 ou um
	// numero >31
