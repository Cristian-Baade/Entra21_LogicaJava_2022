...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * System.out.println("Qual sua altura?"); altura = entrada.nextFloat();
		 * 
		 * System.out.println("Qual seu salário? por favor não minta"); salario =
		 * entrada.nextFloat();
		 * 
		 * System.out.println("Bem vindo "
		 * +nome+" agora consigo interagir com humanos e já sei que vc tem "
		 * +minhaIdade+" anos, tem " +altura+ "cm e ganha " +salario+ " de salario");
		 */
